<?php
namespace ESET\Catalog\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class ESET\Catalog\Controller\ProductController.
 *
...
class ProductControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \ESET\Catalog\Controller\ProductController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('ESET\\Catalog\\Controller\\ProductController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllProductsFromRepositoryAndAssignsThemToView()
	{
		...
		$productRepository = $this->getMock('ESET\\Catalog\\Domain\\Repository\\ProductRepository', array('findAll'), array(), '', FALSE);
